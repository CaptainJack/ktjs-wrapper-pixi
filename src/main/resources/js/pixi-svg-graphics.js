(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory((function webpackLoadOptionalExternalModule() { try { return require("./pixi.min"); } catch(e) {} }()));
	else if(typeof define === 'function' && define.amd)
		define(["./pixi.min"], factory);
	else if(typeof exports === 'object')
		exports["SVGGraphics"] = factory((function webpackLoadOptionalExternalModule() { try { return require("./pixi.min"); } catch(e) {} }()));
	else
	...
	/******/ ([
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			SVGGraphics.prototype.drawPathData = function (data) {
					...
					while (z < points.length) {
						switch (command.toLowerCase()) {
							...
							case 'm':
								...
								if (z === 0) {
									if(subPathIndices.indexOf(i) >= 2 && this.graphicsData[this.graphicsData.length -1].shape.closed != true) {
										this.addHole()
									}
									this.moveTo(x, y);
				...
				if (subPathIndices.length > 1 && this.graphicsData[this.graphicsData.length -1].shape.closed != true) {
					this.addHole()
				}
			}
